/**
 * Part of this code is taken from https://github.com/nextui-org/nextui/blob/main/packages/react/src/utils/system.ts
 */
...
export type OmitCommonProps<Target, OmitAdditionalProps extends keyof any = never> = Omit<Target,

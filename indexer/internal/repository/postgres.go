...
type Collections interface {
	...
	GetCollectionsByOwnerAddressTotal(ctx context.Context, tx pgx.Tx, address common.Address, lastCollectionAddress *common.Address) (uint64, error)
...
type Tokens interface {
	...
	GetCollectionTokensTotal(ctx context.Context, tx pgx.Tx, address common.Address, lastTokenId *big.Int) (uint64, error)
	...
	GetTokensByAddressTotal(ctx context.Context, tx pgx.Tx, address common.Address, lastCollectionAddress *common.Address, lastTokenId *big.Int) (uint64, error)
...
type Transfers interface {
	...
	GetIncomingTransfersByAddressTotal(ctx context.Context, tx pgx.Tx, address common.Address, lastTransferId *int64) (uint64, error)
	...
	GetOutgoingTransfersByAddressTotal(ctx context.Context, tx pgx.Tx, address common.Address, lastTransferId *int64) (uint64, error)
	...
	GetActiveIncomingTransfersByAddressTotal(ctx context.Context, tx pgx.Tx, address common.Address, lastTransferId *int64) (uint64, error)
	...
	GetActiveOutgoingTransfersByAddressTotal(ctx context.Context, tx pgx.Tx, address common.Address, lastTransferId *int64) (uint64, error)
...
type Orders interface {
	...
	GetAllActiveOrdersTotal(ctx context.Context, tx pgx.Tx, lastOrderId *int64) (uint64, error)

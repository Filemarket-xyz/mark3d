...
export const CardWhiteOptions: CardProps[] = [
  ...
  },
  {
    ...
    rightBottomContent: <div style={{ display: 'flex', gap: '32px', flexWrap: 'wrap' }}><Button mediumMxWidth primary style={{ width: '240px' }}>1. Create Collection</Button><Button mediumMxWidth primary style={{ width: '240px' }}>2. Mint NFT File</Button></div>,
    cardType: 'info',
    isImgRight: true
  },
  {
...
export const CardGradientOptions: CardProps[] = [
  {
    ...
    img: EarnCryptoImg,
    text: <>
      <span>FileMarket is an SDK and API for the entire web3 market, enabling the integration of Encrypted FileToken© Protocol for transferring hidden content in any mechanics, whether it be freelance exchanges, educational portals, or other content access services.</span>
    </>,

...
export type EftRsaDerivationFunction = (seed: ArrayBuffer, globalSalt: ArrayBuffer, collectionAddress: ArrayBuffer, tokenId: number , dealNumber: number, options?: { disableWorker: boolean }) => Promise<RsaKeyPair>

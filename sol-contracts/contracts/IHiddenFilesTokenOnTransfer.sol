...
interface IHiddenFilesTokenOnTransfer {
    ...
    function transferFinished(uint256 tokenId);
    ...
    function transferFraudDetected(uint256 tokenId, bool approved);
}
